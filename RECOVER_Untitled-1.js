...
(lib.כפתורבחר = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AA2BpIAAhmQAAgegHgPQgHgOgSgIQgRgHgiAAQgaAAggAFIgEggQAkgGAhAAQBAAAAZAYQAZAYAAAyIAABvgAhYBpIAAh0IAlAAIAAB0g");
	this.shape.setTransform(87.3,2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AhtBjIAGgcQAKAEAMAAQAOAAAFgGQAFgGAAgQIAAh3QgRABgYADIgEgfQAtgGAuABQAtgBAZAIQAZAIANAVQANAVAAAoIAABvIglAAIAAhmQAAgdgEgOQgFgPgPgIQgQgJgiAAIgTAAIAAB9QAAATgEALQgDAKgMAHQgLAGgXAAQgSAAgSgGg");
	this.shape_1.setTransform(61.3,2.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AA1BpIAAhwQAAgWgFgNQgFgOgPgHQgQgIgbAAQgRAAgUACIAACuIglAAIAAjKQApgHAjAAQAmAAAXAMQAXALAKASQAJATAAAiIAABzg");
	this.shape_2.setTransform(37.6,2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgFCPIAAgcQAAgZAFgNQAEgMAKgNIAMgOQAIgLACgJQADgJAAgNIAAgcIhyAAIAAhuIAmAAIAABPIBxAAIAAA0QAAAUgEAOQgEAOgKANIgLAPQgPAVAAAYIAAAhg");
	this.shape_3.setTransform(15.8,-1.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgFCPIAAgcQAAgZAFgNQAEgMAKgNIALgOQAJgLACgJQADgJAAgNIAAgcIhyAAIAAhuIAmAAIAABPIBxAAIAAA0QAAAUgEAOQgEAOgKANIgLAPQgPAVAAAYIAAAhg");
	this.shape_4.setTransform(-13.8,-1.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("AhCBZQgZgSgMghQgMghAAg1IgDg5IAmAAIAAAhQACA0ADAUQAVAAAQgLQARgKAAgdIAEg3IAkAAIgEBBQgBAQgDAJQgCAJgIAIQgHAKgRAHQgRAHgdACQAEAVASANQASANAaAAQAXAAARgMQARgLAJgSQAIgSADghIAIhYIAlAAIgHBMQgEAqgKAdQgLAdgaASQgaARgoAAQglAAgYgRg");
	this.shape_5.setTransform(-36.4,2.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AA1BpIAAhwQAAgWgFgNQgFgOgPgHQgQgIgbAAQgRAAgUACIAACuIglAAIAAjKQApgHAjAAQAmAAAXAMQAXALAKASQAJATAAAiIAABzg");
	this.shape_6.setTransform(-62.2,2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AhQCPIAAjDIAjAAIAADDgAACBAIAAgcQAAgVAEgOQAEgMAMgPIALgPQAJgLADgIQACgJAAgOIAAgcIiDAAIAAgfICoAAIAAAzQAAAWgDAOQgFANgKAOIgKAOQgQAVgBAYIAAAhg");
	this.shape_7.setTransform(-84.8,6.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},3).wait(1));

	// Layer 1
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#00CCFF").s().p("AwPF9IAAr5MAgfAAAIAAL5g");
	this.shape_8.setTransform(1,-1.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#0099FF").s().p("AwPF9IAAr5MAgfAAAIAAL5g");
	this.shape_9.setTransform(1,-1.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8}]}).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_9}]},2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-103,-39.5,208.1,76.3);
...
(lib.start = function(mode,startPosition,loop) {
	...
	this.comboBox1.setTransform(-0.9,1.9,1.42,1.45,0,0,0,50,10.9);

	this.timeline.addTween(cjs.Tween.get(this.comboBox1).wait(1));

}).prototype = getMCSymbolPrototype(lib.start, new cjs.Rectangle(-72.6,-14.6,143.4,111.5), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/RECOVER_Untitled_1_atlas_.png?1517507391490", id:"RECOVER_Untitled_1_atlas_"},
		{src:"sounds/endSund.mp3?1517507392259", id:"endSund"},
		{src:"sounds/boom2mp3.mp3?1517507392259", id:"boom2mp3"},
		{src:"sounds/boom1mp3.mp3?1517507392259", id:"boom1mp3"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1517507392259", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1517507392259", id:"sdk/anwidget.js"},
		{src:"components/ui/src/combobox.js?1517507392259", id:"an.ComboBox"},
		{src:"components/ui/src/button.js?1517507392259", id:"an.Button"}
	],
	preloads: []
};
